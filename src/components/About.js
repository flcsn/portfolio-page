...
const About = () => {
  return (
    <section className='flex flex-col bg-blue-900 p-3 md:p-9 min-w-screen min-h-screen'>
      <div className='flex-grow max-w-screen-lg h-full m-auto'>
        <h2 className='mb-1 md:mb-5 text-xl font-semibold tracking-tight text-slate-200 sm:text-3xl md:text-5xl lg:text-7xl'>About</h2>
        <p className='text-sm text-slate-200 tracking-wide font-light sm:text-lg md:text-xl lg:text-3xl lg:leading-normal'>
      ...
      <div className='flex-grow max-w-screen-lg h-full m-auto'>
        <h2 className='mb-1 md:mb-5 text-xl font-semibold tracking-tight text-slate-200 sm:text-3xl md:text-5xl lg:text-7xl'>A Brief History</h2>
        <p className='text-sm text-slate-200 tracking-wide font-light sm:text-lg md:text-xl lg:text-3xl lg:leading-normal'>
